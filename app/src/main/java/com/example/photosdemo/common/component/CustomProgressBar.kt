package com.example.photosdemo.common.component
...
import com.example.photosdemo.common.util.AnimUtils
...
class CustomProgressBar : ProgressBar {
    ...
    private fun setState(state: State, withAnimation: Boolean = false) {
        if (withAnimation) {
            val animScale = 1.2F
            AnimUtils.getScaleAnimation(
                1F, animScale, 1F, animScale,
